 		...
 		<html>
 			...
 			<body>
 				...
 				<table id="menuTable" border="1" class="indent">
 					<thead>
 						<tr>
 							<th colspan="3">AsianfoodTakeaway</th>
 						</tr>
 						<tr>
 							<th>Select</th>
 							<th>Item</th>
